...
app.get('/location', (request,response) => {
    let url = 'https://maps.googleapis.com/maps/api/geocode/json?address=Port-au-Prince&key=AIzaSyCfYxZzwlvPhuUbZaVqHlW2HMkLt8Ol6eQ'
    superagent.get(url)
...
app.get('/weather',(request,response)=>{
    let url1= 'https://api.darksky.net/forecast/f89425736b1ba654e69ef23694ce40ff/18.594395,-72.3074326'
    superagent.get(url1)
    .then(res => response.send({
